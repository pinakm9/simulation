...
sim_components = [InverseTransform(RVContinuous(support = [0.0, 1.0], cdf = cdf, inv_cdf = inv_cdf, params = n+1)) for n in range(degree)]
sim = Composition(RVContinuous(support = [0.0, 1.0], cdf = target_cdf), sim_components, list(alpha))
